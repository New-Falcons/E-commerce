const initialState = {
  products: [
    ...
    },
    {
      ...
      size: "M",
      quantity: 1,
      url: "https://assets.myntassets.com/f_webp,dpr_1.5,q_60,w_210,c_limit,fl_progressive/assets/images/13510566/2021/3/27/06f20b9d-38c5-469c-8f1b-5f721b56a5351616842092363-Puma-Women-Tights-7351616842091656-5.jpg",
    },
    {
      id: "16",
      title: "GAP",
  ...
  switch (action.type) {
    ...
    case "REMOVE":
      ...
      return {
        ...
        totalPrice: state.totalPrice - parseInt(findPro.price) * findPro.quantity,
